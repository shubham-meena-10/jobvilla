        ...
        <div>
            ...
            <section id='header'>
                <div className='banner text-center'>
                    ...
                    {/* <p className="typing">Subscribe</p> */}
                </div>
            </section>
            ...
            <div className='search-job text-center'>
                <form>
                    ...
                    <button type='submit' className='btn btn-primary' onClick={gotoRegister} >Find Job</button>
                </form>
            </div>
            {/* Top Reqruiters  */}
            ...
            <section id='footer' className='text-center'>
                <img src='logo.png' className='footer-image' alt='logo' />
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, dolor officiis. Blanditiis, quibusdam.<br /> Press the bell icon to get new notification</p>
